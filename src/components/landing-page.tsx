...
import { Contact, Link2, Columns, HandCoins } from "lucide-react";
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center p-6">
                <Contact className="h-10 w-10 mx-auto text-primary mb-4" />
                <h3 className="text-xl font-semibold font-headline">Digital Business Card</h3>
                <p className="text-muted-foreground mt-2 text-sm">Share your professional identity with a scannable QR code and a single link.</p>
              </Card>
              <Card className="text-center p-6">
                <Link2 className="h-10 w-10 mx-auto text-primary mb-4" />
              ...
              <Card className="text-center p-6">
                <Columns className="h-10 w-10 mx-auto text-primary mb-4" />
                <h3 className="text-xl font-semibold font-headline">Content Hub</h3>
                <p className="text-muted-foreground mt-2 text-sm">Showcase products, services, events, and job opportunities on your profile.</p>
              </Card>
              <Card className="text-center p-6">
                <HandCoins className="h-10 w-10 mx-auto text-primary mb-4" />
