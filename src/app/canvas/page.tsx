  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-headline">My Canvas</h1>
            <p className="text-muted-foreground">View, create, and manage all your creations in one place.</p>
          </div>
          <DropdownMenu>
