...
import { PlusCircle, Globe, Mail, Phone, MapPin, Eye, MousePointerClick, ExternalLink, Building2, List, LayoutGrid, Megaphone } from "lucide-react";
import Link from "next/link";
import { useState, useEffect } from "react";
import { Separator } from "@/components/ui/separator";
import { useAuth } from "@/components/auth-provider";
import { getAllPromoPages, type PromoPageWithAuthor } from "@/lib/promo-pages";
...
export default function PromoPagesPage() {
  ...
  const [promoPages, setPromoPages] = useState<PromoPageWithAuthor[]>([]);
