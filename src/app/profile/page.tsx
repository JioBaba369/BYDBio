...
import { PlusCircle, Trash2, User, Link2 as LinkIcon, Upload, GripVertical, Save, Building, Linkedin, Phone, Mail, Globe, ExternalLink, Loader2, Nfc, Sparkles } from "lucide-react"
...
END:VCARD`;
  ...
  return (
    <>
      ...
      />
      <AIBioGenerator
        open={isBioGeneratorOpen}
        onOpenChange={setIsBioGeneratorOpen}
        onSelectBio={(bio) => {
            publicProfileForm.setValue('bio', bio, { shouldDirty: true });
        }}
       />
      <div className="space-y-6">
        <div>
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Button type="button" variant="outline" size="sm" onClick={() => setIsBioGeneratorOpen(true)}>
